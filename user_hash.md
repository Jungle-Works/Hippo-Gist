Hippo user_hash
==================
- Code for generating the user_hash value for [Hippo's Identity verfication]
...
Remember that your secret key should never be exposed to the public as it can lead to data breach.
-------------------------------------------------------------------
